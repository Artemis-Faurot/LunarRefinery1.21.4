...
public class LuniteShovel extends ShovelItem {
    public LuniteShovel(Settings settings) {
        super(LunarRefineryToolMaterials.LUNITE_TOOL_MATERIAL, 1.5F, -3.0F, settings);
    }

    public static final String name = "lunite_shovel";
    public static final String displayName = "Lunite Shovel";
