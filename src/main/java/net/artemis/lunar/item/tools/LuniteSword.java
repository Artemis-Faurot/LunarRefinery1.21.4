...
public class LuniteSword extends SwordItem {
    public LuniteSword(Settings settings) {
        super(LunarRefineryToolMaterials.LUNITE_TOOL_MATERIAL, 3.0F, -2.4F, settings);
    }

    public static final String name = "lunite_sword";
    public static final String displayName = "Lunite Sword";
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Makes hostile mobs have a 50% to drop Lunite Dust").formatted(Formatting.AQUA));
